...
author: "Simon Herrmann (11908690), Sungho Park (12469817), Jonas Reinhard(12442176)"
date: "`r Sys.Date()`"
output:
...
These functions provide convenient ways to manipulate and transform strings in 
R, allowing you to create palindromes, swap symbols at specific positions 
within a given string and counts the number of characters in a given string and
...
b)  To make installation easier, your R package should be in a public
    ...
    below:`https://github.com/SimonAtLMU/exeRcise-sheet-6'
...
``` r
remotes::install_github("SimonAtLMU/exeRcise-sheet-6/simonsunghojonas")
```
